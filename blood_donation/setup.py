...
setup(
    ...
    author="hemanth",
    author_email="hemanthk.b@proton.me",
    maintainer="hemanthk7504",
    url="https://github.com/Hemanthk7504/blood_donation",
    ...
    keywords="Blood donation api graphql rest relay graphene auth",
    zip_safe=False,
